...
def run_config_wizard(output_dir: str = "configs") -> str:
    ...
    print(f"{BOLD}{CYAN}  PentestFW — Configuration Wizard{NC}")
    print(f"{BOLD}{CYAN}{'='*60}{NC}")
    print()
    ...
    header = (
        "# =============================================================================\n"
        f"# PentestFW Configuration — Generated by Config Wizard\n"
        f"# File: {out_path}\n"
    ...
    try:
        ...
        print()
        print(f"  Use it with:")
        print(f"    {CYAN}sudo python3 pentestfw.py -t <target> -m full -c {out_path} -v{NC}")
        print()
        return str(out_path)
